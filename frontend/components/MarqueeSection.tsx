...
const PARTNERS: Partner[] = [
  {
    ...
    name: "IIT KANPUR",
    logoMark: (
      <svg className="w-5 h-5 text-t-2 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="flex w-max items-center gap-16 sm:gap-24 whitespace-nowrap animate-marquee">
          {displayPartners.map((partner, index) => (
            <div
              ...
              className="flex items-center gap-3.5 font-syne text-[14px] sm:text-[15px] font-extrabold text-t-2 tracking-widest transition-colors duration-300 hover:text-brand-g cursor-pointer"
            >
              {partner.logoMark}
