...
const PILLARS_ICONS = [
  (
    <svg key="pillar-icon-0" viewBox="0 0 24 24" className="w-6 h-6 fill-none stroke-brand-gl stroke-2 stroke-linecap-round stroke-linejoin-round">
      <path d="M9 11l3 3L22 4" />
      <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" />
    </svg>
  ),
  (
    <svg key="pillar-icon-1" viewBox="0 0 24 24" className="w-6 h-6 fill-none stroke-brand-gl stroke-2 stroke-linecap-round stroke-linejoin-round">
      <rect x="3" y="3" width="18" height="18" rx="2" />
      <path d="M3 9h18M9 21V9" />
    </svg>
  ),
  (
    <svg key="pillar-icon-2" viewBox="0 0 24 24" className="w-6 h-6 fill-none stroke-brand-gl stroke-2 stroke-linecap-round stroke-linejoin-round">
      <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
    </svg>
  ),
  (
    <svg key="pillar-icon-3" viewBox="0 0 24 24" className="w-6 h-6 fill-none stroke-brand-gl stroke-2 stroke-linecap-round stroke-linejoin-round">
